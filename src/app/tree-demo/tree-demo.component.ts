...
//name children can be anything
// function passed to NestedTreeControl as an argument tells how to access children
nestedTreeControl = new NestedTreeControl<CourseNode>(node=> node.children);
 
//flat Tree  uses levels for indenting
//mat-tree are not nested into one another 
